...
// EJERCICIO 17 : FORZAR ERROR DE MEMORIA
...
void listAddFirst(list_t* l, void* data) {
    ...
    switch(l->type) {
        case TypeFAT32:
            n->data = (void*) copy_fat32((fat32_t*) data); // estas casteando data
            break;
        default:
            n->data = NULL;
            break;
...
void listAddLast(list_t* l, void* data) {
    ...
    n->next = NULL; //como va al final, no tiene a nadie despues
    n->prev = l->last; //su anterior es el que era el ultimo
...
void listDelete(list_t* l) {
    ...
    while(n) { //= while (n != NULL)
        ...
        El reporte de Valgrind confirma con precisión 
        la fuga de memoria provocada al omitir free(tmp)
...
PARA CORRER EL EJECUTABLE CON VALGRIND:

valgrind --leak-check=full ./ej17
